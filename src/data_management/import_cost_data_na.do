...
* Load main data set.
import excel `"${PATH_IN_DATA}/costdata_na.xlsx"', sheet("Sheet1") firstrow clear
...
* Compute how many years between TPP-software year and auction.
...
sort year id id_within
save `"${PATH_OUT_DATA}/na_costfrequencydata.dta"', replace
log close