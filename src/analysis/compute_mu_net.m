...
fprintf('FOR NET AUCTION SAMPLE\n\n');
...
VarNames_mu_net = {'MU_I','MU_E','ratio'};
mu_data_net = table(MU_average(:,1), MU_average(:,2), MU_average(:,3), ...
			  'VariableNames', VarNames_mu_net);
% Export efficiency data to to csv-file.
writetable(mu_data_net, project_paths('OUT_ANALYSIS','average_mu_net.csv'));
